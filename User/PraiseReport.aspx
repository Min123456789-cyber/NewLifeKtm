<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="PraiseReport.aspx.cs" Inherits="NewLifeKtm.User.PraiseReport" %>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h1 class="text-center">Praise Report</h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <asp:TextBox ID="txtPrayer" CssClass="form-control" runat="server" placeholder="Enter Your Praise Report" TextMode="MultiLine" required=""></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
